...
import {
  ...
  script5 as script11,
  script6 as script13
} from "./chunk-ONOHXA6K.js";
import {
  script as script4,
  script2 as script7,
  script3 as script12
} from "./chunk-7SUXBXVX.js";
import {
  FilterService
} from "./chunk-RS3FVWXE.js";
import {
  script as script3
} from "./chunk-J425QWKE.js";
import {
  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      if (selected)
        ...
        value = [].concat(_toConsumableArray2(this.modelValue || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0)
              filtered.push(_objectSpread(_objectSpread({}, group), {}, _defineProperty$1({}, typeof _this25.optionGroupChildren === "string" ? _this25.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
...
var _hoisted_13 = ["id", "disabled", "placeholder", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-invalid"];
var _hoisted_23 = ["id", "aria-label"];
var _hoisted_3 = ["id"];
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("hiddenInput")), null, 16, _hoisted_13)], 16), createBaseVNode("div", mergeProps({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            content: withCtx(function(_ref2) {
              ...
              })], 16)) : createCommentVNode("", true)], 16, _hoisted_23)];
            }),
            _: 2
          }, [_ctx.$slots.loader ? {
            name: "loader",
